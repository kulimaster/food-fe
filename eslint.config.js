...
export default defineConfig([
  ...
  {
    // A feature must not import from another feature: share via components/ or lib/ instead.
          ...
          patterns: [
            {
              ...
              message:
                'Features must not import from other features. Move shared code to components/ or lib/.',
            },
          ],
        },
      ],
